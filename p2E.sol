...
contract P2EGame is  Ownable {
    ...
    // address constant tokenAddress = 0xf40cd86053A80AD8c3320988Cb97Eed14db70AEe; // <-- INSERT DEPLYED ERC20 TOKEN CONTRACT HERE
    address constant tokenAddress = 0x2c24c67904CBB29A851c2f6f18631Cd4Bff5ba14;
    uint256 public maxSupply = 100000000000000000000; // <-- temporaily set manually for flexibility while in pre-alpha development
    uint256 public unit = 1; // <-- temporaily set manually for flexibility while in pre-alpha development
    ...
    function createGame(
        ...
        UtilityToken token = UtilityToken(tokenAddress);
        //unit = token.unit();
